...
def process_media(audio_path, image_path):
    try:
        ...
        audio_duration = user_audio.duration  # Get duration here

        user_image = ImageClip(image_path, duration=audio_duration)
        ...
        image_scaled = image_scaled.set_duration(audio_duration) # Match duration
        ...
        bg_music_trimmed = bg_music.subclip(0, audio_duration)
